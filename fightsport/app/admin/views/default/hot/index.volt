<a class="btn_admin" href="{{ this.url.get('admin/hot/create') }}">New</a>
<br /> <br />
<table style="width: 100%;">
    ...
    <tr>
        ...
        <td><?=$item['name'] ?></td>
        <td class="tdend alignCenter"><a href="{{ this.url.get('admin/hot/edit/' ~ item['id']) }}">Edit</a> | <a onclick="if(_active()) return true; else return false; " href="{{ this.url.get('admin/hot/delete/' ~ item['id']) }}">Delete</a></td>
    </tr>
    <?php }?>
</table>
