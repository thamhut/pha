        ...
        <div class="column-left">
            ...
            <div class="label_share">
                ...
                <div style="float: left; margin-left: 5px;">
                    <div class="fb-share-button" data-href="<?=$this->url->get('detail/'.$this->utils->converToUrl($data['content']['title']).'_i'.$data['content']['id'].'.html')?>" data-layout="button_count"></div>
                    <div id="fb-root"></div>
            ...
            <div class="content">
                ...
                <b>TAGS:</b>
                    ...
                    <?php 
                        ...
                        {
                    ?>
                         <li style="display: inline-block; padding: 5px; background-color: #eee; border: 1px solid #ddd; margin: 0 5px;"><a href="<?=$this->url->get('tag/index/'.$this->utils->converToUrl(trim($item)))?>"><?= trim($item); ?></a></li>
                    <?php
                        }
                    ?>
                    </ul>
                ...
                <br />
                <div style="width: 690px; height: 120px;">
                    <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                    <!-- content_fightsport -->
                    <ins class="adsbygoogle"
                         style="display:block"
                         data-ad-client="ca-pub-3431173096387405"
                         data-ad-slot="7236976374"
                ...
                <br />
                <div class="fb-comments" data-href="<?=$this->url->get('detail/'.$this->utils->converToUrl($data['content']['title']).'_i'.$data['content']['id'].'.html')?>" data-width="690" data-numposts="10"></div>
                <div id="fb-root"></div>
                    <script>(function(d, s, id) {
                      var js, fjs = d.getElementsByTagName(s)[0];
                      if (d.getElementById(id)) return;
