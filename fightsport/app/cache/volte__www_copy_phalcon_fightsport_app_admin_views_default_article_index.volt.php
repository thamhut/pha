<a class="btn_admin" href="<?php echo $this->url->get('admin/article/create'); ?>">New</a>
<br /> <br />
<table style="width: 100%;">
    ...
    <tr>
        ...
        <td class="tdend alignCenter"><a href="<?php echo $this->url->get('admin/article/edit/' . $item['id']); ?>">Edit</a> | <a onclick="if(_active()) return true; else return false; " href="<?php echo $this->url->get('admin/article/delete/' . $item['id']); ?>">Delete</a></td>
    </tr>
    <?php }?>
    <tr class="label_tr">
        <td colspan="4" class="tdend"><?php echo $this->partial('pagination'); ?></td>
    </tr>
</table>
