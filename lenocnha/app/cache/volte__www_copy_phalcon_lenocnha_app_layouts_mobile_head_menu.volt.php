<div data-role="header">
    <header data-theme="b" id="homeheader" data-role="header" style="" role="banner" class="ui-header ui-bar-a">
        ...
        <div style="float: left; overflow: hidden;margin:10px 0 0 10px; height: 20px;">
            <img src="<?php echo $this->url->getStatic(); ?>public/img/logo.png" height="100%" />
        </div>
        <div style="float: right; overflow: hidden;">
            <div style="width: 62px; height: 45px; vertical-align: middle; display: table-cell;">
                <span><a href="#cse-search-box" data-rel="popup" data-transition="slide"><img style="opacity: 0.8;" src="<?php echo $this->url->getStatic(); ?>public/img/icon_search.png" /></a>
                <a href="#popupMenu1" data-rel="popup" data-transition="slidedown"><img style="opacity: 0.8;"  src="<?php echo $this->url->getStatic(); ?>public/img/menu_icon.png" /></a></span>
            </div>
        </div>
...
@import url(//www.google.com/cse/api/branding.css);
    ...
    <form data-theme="a" style="float: left;width: 215px;   border: none !important;background: transparent;" data-role="popup"  action="http://lenocnha.com/search" id="cse-search-box">
      <div>
