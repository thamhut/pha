        ...
        <ul>
            ...
            <li>
                ...
                <div style="float: left; width: 580px;">
                    <div class="title_item_music"><a title="<?php echo $inonstop['title']; ?>" target="_blank" href="<?php echo $this->url->get('detail/'.$this->utils->converToUrl($inonstop['title']).'_i'.$inonstop['id']).'.html'; ?>"><h3><?php echo $inonstop['title']; ?></h3></a></div>
                    ...
                    <a href="<?php echo $this->url->get('category').'/'.$this->utils->converToUrl($inonstop['name']).'_i'.$inonstop['id_cate']; ?>"><?php echo $inonstop['name']; ?></a>
                    &nbsp;
                    <?php
                    for($i=1; $i<=5; ++$i)
                    {
        ...
        <ul>
            ...
            <li>
                ...
                <div style="float: left; width: 580px;">
                    ...
                    <img style="vertical-align: middle; margin: 0px 5px;" src="/public/img/arrow_right.png" /> <a href="<?php echo $this->url->get('category').'/'.$this->utils->converToUrl($inonstop['name']).'_i'.$inonstop['id_cate']; ?>"><?php echo $inonstop['name']; ?></a>
                    <?php
                    for($i=1; $i<=5; ++$i)
                    {
                        if($i<round($inonstop['point']/2))
