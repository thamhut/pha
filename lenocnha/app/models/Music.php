...
class Music extends Model
{
    ...
    public function getMusicByCate($idCate, $page, $numItem)
    {
        ...
        $sql->andwhere('Module\Models\Music.active = 1');
    ...
    public static function nhacsan_get_music_top($fdate, $tdate, $id)
    {
        ...
        $sql->andwhere('Module\Models\Music.active = 1');
        $sql->andwhere('Module\Models\MusicDate.date >= "'.$fdate.'" AND Module\Models\MusicDate.date <= "'.$tdate.'"');
        $result = ($sql->getQuery());
        return ($result->execute()->toArray());
    }
    ...
    public function getlistMusicByCate($page, $numItem)
    {
        ...
        if(isset($this->date_sort) && $this->date_sort)
        {
            $order = 'Module\Models\Music.id DESC';
        }
        $query = array(
            'models' => array('Module\Models\Music'),
