<div class="left_menu">
    ...
    <div class="item_menu_left marT20">
        <ul>
            ...
            ?>
            <li><img src="/public/img/arrow_right_left_menu.png" />&nbsp;&nbsp;&nbsp;
                <a style="<?php echo $k==0?'color:#e05e12':'';echo $k==1?'color:green':'';echo $k==2?'color:cornflowerblue':''; ?>" href="<?= $this->url->get().'/user/member_i'.$iuser['id_user']; ?>" title="<?php echo $iuser['username']; ?>">
