...
class UserController extends ControllerBase
{
    public function indexAction()
    {
        ...
        $this->view->id = $id = (int)$this->dispatcher->getParam('id');
        if(isset($session['id']) || $id)
        {
            $music = new Music;
            ...
            $data['id'] = $music->id_user = $session['id'];
            $data['info'] = User::findFirst($session['id']);
            $data['info']->num = $num = Music::count(array(
                "id_user = :id_user:",
                "bind" => array('id_user' => $session['id']),
            ));
