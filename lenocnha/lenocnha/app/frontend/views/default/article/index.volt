        ...
        <?php if(!isset($done)){ ?>
            ...
            <fieldset class="box_upload">
                ...
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td><div class="button_div" onclick="postarticle();" style="width: 70px;">Đăng bài</div></td>
                    </tr>
            ...
            <?php }else{echo '<h3><p style="color: #D15B00;padding-top: 50px;text-align: center;">Đăng bài thành công!<br>Hãy đợi chúng tôi duyệt bài đăng. Xin cảm ơn!</p></h3>';}?>
        </div>
        <div class="clear"></div>
    </div>
</div>
