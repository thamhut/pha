<div role="main"  data-theme="a">
    ...
    <ul data-role="listview" data-inset="true" data-divider-theme="a">
        ...
        ?>
        <li data-icon="action"><a href="<?php echo $this->url->get('category').'/remix_i2.html'?>" class="ui-btn ui-btn-inline continue_view" data-icon="action">Xem tiếp...</a></li>
    </ul>
    ...
    <ul data-role="listview" data-inset="true" data-divider-theme="a">
        ...
        ?>
        <li data-icon="action"><a href="<?php echo $this->url->get('category').'/electronic-house_i3.html'?>" class="ui-btn ui-btn-inline continue_view" data-icon="action">Xem tiếp...</a></li>
    </ul>
    ...
    <ul data-role="listview" data-inset="true" data-divider-theme="a">
        ...
        ?>
        <li data-icon="action"><a href="<?php echo $this->url->get('category').'/producer-vn_i4.html'?>" class="ui-btn ui-btn-inline continue_view" data-icon="action">Xem tiếp...</a></li>
    </ul>
    ...
    <ul data-role="listview" data-inset="true" data-divider-theme="a">
        ...
        ?>
        <li data-icon="action"><a href="<?php echo $this->url->get('category').'/dance-trance_i5.html'?>" class="ui-btn ui-btn-inline continue_view" data-icon="action">Xem tiếp...</a></li>
    </ul>
    ...
    <ul data-role="listview" data-inset="true" data-divider-theme="a">
        ...
        ?>
        <li data-icon="action"><a href="<?php echo $this->url->get('category').'/video-dj_i6.html'?>" class="ui-btn ui-btn-inline continue_view" data-icon="action">Xem tiếp...</a></li>
    </ul>
