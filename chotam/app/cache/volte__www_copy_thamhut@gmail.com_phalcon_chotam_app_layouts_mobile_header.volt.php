<head>
    ...
    <meta name="title" content="<?php if ((isset($meta_title)) && $meta_title != '') { ?> <?php echo $meta_title; ?> <?php } else { ?> <?php echo 'chotam.info - Tổng hợp các tin tức rao vặt, mua bán, bất động sản, kết bạn bốn phương, kết bạn online, tìm kiếm hàng ngày.'; ?> <?php } ?>" />
    <meta name="keywords" content="<?php if ((isset($meta_title)) && $meta_title != '') { ?> <?php echo $meta_title; ?> <?php } else { ?> <?php echo 'chotam.info - Tổng hợp, tin tức, rao vặt, mua bán, bất động sản, kết bạn bốn phương, kết bạn online, tìm kiếm.'; ?> <?php } ?>" />
    <meta name="description" content="<?php echo (((isset($meta_content)) && $meta_content != '') ? $meta_content : 'Toàn bộ thông tin về rao bán, kết bạn bốn phương, kết bạn online, rao vặt cho thuê hàng hóa nhà cửa, bất động sản, nhà cửa đều được tổng hợp trên trang web.'); ?>" />
