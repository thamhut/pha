<div role="main" class="ui-content" data-theme="b">
    <div>
        <div>
            ...
            ?>
            <img itemprop="image" id="img_1" alt="<?= $this->utils->enhtml($data['data_content']->title) ?>"  src="<?php echo isset($img_first)&&$img_first!=''?$img_first:'/public/img/noimg.png';  ?>" style="max-width: 200px; max-height: 200px; width: 200px; height:200px;" />
            <div style="background: url(http://cdn.m.husqvarna.net/App_Themes/hq/carousel-button.png) no-repeat scroll 0 0 #fff;border-color: #fff;box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.6);
            ...
            <div data-role="tabs" id="tabs">
              ...
              <div id="one" class="ui-body-d ui-content">
                <h1 itemprop="name"><?= $this->utils->enhtml($data['data_content']->title) ?></h1>
    ...
    <ul data-role="listview" data-filter="true" itemscope itemtype="http://schema.org/BreadcrumbList">
        ...
        <a itemprop="url" data-ajax="false" href="<?php echo $this->url->get('detail/'.$this->utils->converToUrl($itemContent['title']).'_i'.$itemContent['id']).'.html'; ?>">
            <img itemprop="image" alt="<?php echo $this->utils->enhtml($itemContent['title']); ?>" src="<?php if(isset($img_first) && $img_first!='')echo $img_first; else echo $this->url->get().'public/img/noimg.png';?>" width="90" height="90" />
