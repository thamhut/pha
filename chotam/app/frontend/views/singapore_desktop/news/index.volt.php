...
<div class="box_container">
    ...
    <div id="input_data_new" class="register" >
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <table  id="tb_lienhe">
                 <tr>
                    <td><label><?php echo $lang->_('label_phone'); ?>:</label></td><td style="padding-left:26px !important;"><label><?php echo $lang->_('label_email'); ?>:</label></td>
                </tr>
                ...
                <tr>
                    <td><label><?php echo $lang->_('label_yahoo'); ?>:</label></td><td style="padding-left:26px !important;"><label><?php echo $lang->_('label_skype'); ?>:</label></td>
                </tr>
