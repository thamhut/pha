        ...
        <form action="" method="post" enctype="multipart/form-data">
            <table id="tb_news">
                ...
                <tr class="tr_choise_img" id="div_choise_img-1-tr">
                    <td>
                        <div>{{ form.render('img', ['class':'div_choise_img', 'id':'div_choise_img-1', 'onchange':'abc(this)', 'name':'img[]']) }}</div>
                    </td>
                </tr>
            ...
            <table  id="tb_lienhe">
                 <tr>
                    <td><label>{{ lang._("label_phone") }}:</label></td><td style="padding-left:26px !important;"><label>{{ lang._("label_email") }}:</label></td>
                </tr>
                ...
                <tr>
                    <td><label>{{ lang._('label_yahoo') }}:</label></td><td style="padding-left:26px !important;"><label>{{ lang._('label_skype') }}:</label></td>
                </tr>
            ...
            <input type="submit" name="submit" value="Post" class="submit_dangtin" />
        </form>
    </div>
    <div id="danhgia">
