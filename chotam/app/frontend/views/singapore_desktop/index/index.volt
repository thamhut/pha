    ...
    <div id="add_top">
    	...
    	<div class="scrollable" id="scrollable">   
           ...
           {% for key,value in content_data %}
               <div><a href='{{ this.url.get("detail/" ~ this.utils.converToUrl(value["title"])) ~ "_i" ~ value["id"] ~ ".html" }}'>
                    <img src='{{ this.utils.explode_first(value["img"], ",") != null ? this.utils.explode_first(value["img"], ",") : "/public/img/noimg.png" }}' />
                    <h4 style="padding: 3px 40px;color:#08c">{{ this.utils.gettitle(value["title"]) }}...</h4>
               </a></div>
           {% endfor %}
           </div>
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/stuff-for-sale.png" />
                            <a href="{{ static_url('category/stuff-for-sale_i1')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Stuff for sale</a>
                        </li>
                        <br />
                         <?php
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/jobs.png" />
                            <a href="{{ static_url('category/jobs_i69')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Jobs</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/property.png" />
                            <a href="{{ static_url('category/property_i49')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Property</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/home-furnishing.png" />
                            <a href="{{ static_url('category/home-furnishing_i33')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Home Furnishing</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/vehicles.png" />
                            <a href="{{ static_url('category/vehicles_i59')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Vehicles</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/community.png" />
                            <a href="{{ static_url('category/community_i118')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Community</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/petspet-care.png" />
                            <a href="{{ static_url('category/pets-pet-care_i103')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Pets/Pet Care</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/entertainment--events.png" />
                            <a href="{{ static_url('category/entertainment-events_i129')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Entertainment & Events</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
               ...
               <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/services.png" />
                            <a href="{{ static_url('category/services_i135')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Services</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/travel.png" />
                            <a href="{{ static_url('category/travel_i153')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Travel</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/clothesbeauty.png" />
                            <a href="{{ static_url('category/clothes-beauty_i38')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Clothes/Beauty</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/public/img/electronics.png" />
                            <a href="{{ static_url('category/electronics_i25')  }}" style="color: rgb(0, 136, 204); font-weight: bold; font-size: 14px; padding-left: 5px;">Electronics</a>
                        </li>
                        <br />
                         <?php
                        foreach($category_data as $item)
