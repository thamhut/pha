...
<div class="div_box_container_left">
    ...
    <div class="box_data_new">
        <div id="title_new" class="wordbreak"><h2><?php echo $this->utils->enhtml($data['data_content']->title); ?></h2></div>
        ...
        <div id="des_new" class="padT10 padB10">
            ...
            <div class="clear"></div>
            <div id="div_control">
                <span id="span_rank" title="{{ lang._('rank') }}">{{ lang._('rank') }} <?= $data['rank']; ?></span>
                <span id="span_gotop" title="{{ lang._('go_top') }}" onclick="gotop('<?php echo ($data['data_content']->id); ?>', '<?= $checkuser?>', '<?php echo ($data['data_content']->id_user); ?>');"></span>
    ...
    <div class="div_box_container_right">
        ...
        <div class="div_lst_cate div_lst_news_hot">
            <ul>
                <li class="li_title">{{ lang._('hot_post') }}</li>
                <?php 
