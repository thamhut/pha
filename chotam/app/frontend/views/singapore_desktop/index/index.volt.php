        ...
        <div id="append_partner">
            ...
            <div style="float: left; width:250px;">
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/stuff-for-sale.png" />
                        ...
                        foreach($category_data as $item)
                        {
                            if($item['id']==1)
                            {
                                ...
                                echo '<img src="http://chotam.info/skin/default/img/icon_parrow_right.gif" />&nbsp;&nbsp;&nbsp;'.$item['name'].'</a></li>';
                            }
                        }
                        ?>
                    </ul>
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/jobs.png" />
            ...
            <div style="float: left; width:250px;">
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/property.png" />
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/home-furnishing.png" />
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/vehicles.png" />
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/community.png" />
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/petspet-care.png" />
            ...
            <div style="float: left; width:250px;">
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/entertainment--events.png" />
            ...
            <div style="float: left; width:250px;">
               ...
               <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/services.png" />
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/travel.png" />
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/clothesbeauty.png" />
                ...
                <div style="padding:0px; height:auto;" class="item_profile">
                    <ul>
                        <li class="li_title" style="text-align: left;padding-left:10px;"><img style="vertical-align: middle;" width="28px" src="http://chotam.info/skin/default/img/electronics.png" />
