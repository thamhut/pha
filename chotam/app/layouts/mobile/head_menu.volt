<div data-role="header">
        <header data-theme="a" id="homeheader" data-role="header" style="" role="banner" class="ui-header ui-bar-a">
            ...
            <div style="float: left; overflow: hidden;margin:10px 0 0 10px;">
                <img src="http://chotam.info//public/img/icon_header.png" />
            </div>
            <div style="float: right; overflow: hidden;">
                <div style="width: 62px; height: 45px; vertical-align: middle; display: table-cell;">
                    <span><a href="#popupMenu2" data-rel="popup" data-transition="slide"><img src="http://chotam.info/public/img/icon_search.png" /></a><a href="#popupMenu1" data-rel="popup" data-transition="slidedown"><img  src="http://chotam.info/public/img/menu_icon.png" /></a></span>
                </div>
            </div>
    ...
    <div data-role="popup" id="popupMenu1" class="ui-collapsible-set" data-role="collapsible-set">
        <div class="ui-collapsible ui-collapsible-inset "  data-role="collapsible">
            <h3>
                {{ user['id'] is defined ? 'Thông tin cá nhân' : 'Đăng nhập' }}
            </h3>
            <ul data-role="listview">
                {% if user['id'] is defined %}
                    
                    <li><a data-ajax='false' href="{{ static_url() }}user/update" >Cập nhật tài khoản</a></li>
                    <li><a data-ajax='false' href="{{ static_url() }}user/changepass">Thay đổi mật khẩu</a></li>
                    <li><a data-ajax='false' href="{{ static_url() }}news/mynews">Xem tin đăng</a></li>
                    
                {% else %}
                    <li data-mini="true"><a data-mini="true" data-ajax='false' href="{{ static_url() }}user/login">Đăng nhập</a></li>
                    <li data-mini="true"><a data-mini="true" data-ajax='false' href="{{ static_url() }}user/register">Đăng ký</a></li>
        ...
        <div class="ui-collapsible ui-collapsible-inset "  data-role="collapsible">
            <h3>Danh mục tin</h3>
            <ul data-role="listview">
                <li><a data-ajax='false' href="{{ static_url('category/viec-lam_i1') }}">Việc làm</a></li>
                <li><a data-ajax='false' href="{{ static_url('category/bat-dong-san_i13') }}">Bất động sản</a></li>
                <li><a data-ajax='false' href="{{ static_url('category/dien-thoai_i18') }}">Điện thoại</a></li>
                <li><a data-ajax='false' href="{{ static_url('category/mua-ban_i26') }}">Mua bán</a></li>
                <li><a data-ajax='false' href="{{ static_url('category/dien-tu-gia-dung_i37') }}">Điện tử gia dụng</a></li>
                <li><a data-ajax='false' href="{{ static_url('category/may-tinh_i45') }}">Máy tính</a></li>
                <li><a data-ajax='false' href="{{ static_url('category/phuong-tien-di-lai_i52') }}">Phương tiện đi lại</a></li>
                <li><a data-ajax='false' href="{{ static_url('category/thoi-trang-my-pham_i59') }}">Thời trang - mỹ phẩm</a></li>
                <li><a data-ajax='false' href="{{ static_url('category/me-va-be_i65') }}">Mẹ và bé</a></li>
                <li><a data-ajax='false' href="{{ static_url('category/sim-the_i72') }}">Sim thẻ</a></li>
                <li><a data-ajax='false' href="{{ static_url('category/dich-vu_i80') }}">Dịch vụ</a></li>
			</ul>
        </div>
        <div class="ui-collapsible ui-collapsible-inset "  data-role="collapsible">
            <h3><?php 
